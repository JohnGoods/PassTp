...
/*
如果是要在R0里hook，作者的建议是InLine HOOK，毕竟SSDT HOOK 和 SHADOW SSDT HOOK比较麻烦，
不好修改。目前R3的InLine HOOK 我比较喜欢的是 MINI HOOK ENGINE，
但是今天要解决的是R0的InLine HOOK问题*/
//功能:初始化反汇编引擎
void LDE_init()
{
	...
	IN PIRP pIrp)
{
	...
	case IOCTL_SymbolsInfo:
		...
		__try
		{
			/*bbs.pediy.com/thread-187214.htm 过PG*/
